...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " qty </p>\n            ");
    }).join('');
  }
...
function placeOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/orders', formObject).then(function (res) {
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      ...
      progressBar: false
    }).show(); //to delay the redirect so that the notification of Order placed is read
...
var cartCounter = document.querySelector('#cartCounter'); //This addToCart will be of array type and all the buttons will come here

function updateCart(book) {
  //we have to give a post request on the server and book to our cart
  //axios is  a library
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', book).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var book = JSON.parse(btn.dataset.book); //here we are receiving the data of whose button was clicked. Since we have received the string form of the data. So we are again converting it into JSON form
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:m A');
...
updateStatus(order);
Object(_stripe__WEBPACK_IMPORTED_MODULE_4__["initStripe"])(); //socket client side work
...
/*!********************************!*\
  !*** ./resources/js/stripe.js ***!
  \********************************/
/*! exports provided: initStripe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initStripe", function() { return initStripe; });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51Hsk3RBZucs78X1xYClNorS4Xwd9gwwrVAmUQ99sZdilyrH6LUAsH4gcO3Qkc0DrWy1sOTcTYIYyLtq0OswKoDOY00ck9YqBbS');
...
__webpack_require__(/*! C:\Users\Lenovo\Desktop\mini_projects\bookDelivery\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Lenovo\Desktop\mini_projects\bookDelivery\resources\scss\app.scss */"./resources/scss/app.scss");
